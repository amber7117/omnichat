...
// 导入新添加的角色
import { BOSS_MINGYANG } from "./practical-agents/boss-mingyang";
import { PROGRAMMER_WEI } from "./practical-agents/programmer-wei";
import { EMPLOYEE_AFU } from "./practical-agents/employee-afu";
// 导入杠精主持人
...
export const PARTICIPANT_IDS = {
  ...
  // 新增角色ID
  BOSS_MINGYANG: "boss-mingyang",
  PROGRAMMER_WEI: "programmer-wei",
  EMPLOYEE_AFU: "employee-afu",
} as const;
...
- 未来趋势：...（基于合理推测）`,
  ...
  // 添加新角色
  [PARTICIPANT_IDS.BOSS_MINGYANG]: BOSS_MINGYANG,
  [PARTICIPANT_IDS.PROGRAMMER_WEI]: PROGRAMMER_WEI,
  [PARTICIPANT_IDS.EMPLOYEE_AFU]: EMPLOYEE_AFU,
};
...
export const AGENT_COMBINATIONS = {
  ...
  // AI对小姐行业的影响讨论团队
  aiSexIndustryDiscussion: {
    name: "AI对小姐行业的影响",
    description: "讨论AI技术对性服务行业的影响和帮助",
    moderator: MODERATOR_IDS.BUSINESS_MODERATOR,
    participants: [
      PARTICIPANT_IDS.BOSS_MINGYANG,
      PARTICIPANT_IDS.PROGRAMMER_WEI,
      PARTICIPANT_IDS.EMPLOYEE_AFU,
    ],
  },
